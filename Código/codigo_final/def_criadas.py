...
dicionario_dataframes['escolas-dez-2010.csv'].rename(columns = {"NOMES": "NOMESC", "NOMESCOFI": "NOMESCOF",
                                                "CD_CIE": "CODCIE"}, inplace = True, )



# %%
for index , df in enumerate(dicionario_dataframes):
    #print(index, df)
    dicionario_dataframes[index] = df.rename(columns = {"NOMES": "NOMESC", 
                                                        "NOMESCOFI": "NOMESCOF",
                                                        "CD_CIE": "CODCIE"}, inplace = True, )
...
# %%
dicionario_dataframes_corretos['escolas-dez-2010.csv'].columns

# %%


#NOTE - Tratamento manual
for index , df in enumerate(dicionario_dataframes_corretos):
    print(index)
    dicionario_dataframes_corretos[index].rename({colums "NOMES": "NOMESC",
                                                    "NOMESCOFI": "NOMESCOF",
                                                    "CD_CIE": "CODCIE"}, inplace = True)
# %%
# for df in dicionario_dataframes_corretos.values():
#     print(df.columns)

dicionario_dataframes_corretos['escolas-dez-2010.csv'] = dicionario_dataframes_corretos['escolas-dez-2010.csv'].rename({ "NOMES": "NOMESC",
                                                                                                                        "NOMESCOFI": "NOMESCOF",
                                                                                                                        "CD_CIE": "CODCIE"}, inplace= True, errors = 'ignore')
# %%
dicionario_dataframes_corretos['escolas-dez-2010.csv'].columns
# %%

dicionario_dataframes_corretos['escolas-dez-2010.csv'].rename({ "NOMES": "NOMESC",
                                                                "NOMESCOFI": "NOMESCOF",
                                                                "CODCIE":"CD_CIE"})
...
# %%
for index , df in enumerate(dicionario_dataframes_corretos):
    print(index, dicionario_dataframes_corretos[df].columns) 
